...
My solution for classes and objects question of Hackerrank.com.

Question : https://www.hackerrank.com/challenges/classes-objects/problem?isFullScreen=true
Question : A class defines a blueprint for an object. We use the same syntax to declare objects of a class as we use to declare variables of other basic types. For example:
